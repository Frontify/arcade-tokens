...
module.exports = {
  box: {
    ...
    // Selected
    "selected-color"                        : { value: "{color.violet.80.value}", attributes: { category: "color" } },
    "selected-color-hover"                  : { value: "{color.violet.90.value}", attributes: { category: "color" } },
    "selected-color-pressed"                : { value: "{color.violet.100.value}", attributes: { category: "color" } },
    "selected-inverse-color"                : { value: "{color.violet.20.value}", attributes: { category: "color" } },
    "selected-inverse-color-hover"          : { value: "{color.violet.30.value}", attributes: { category: "color" } },
    "selected-inverse-color-pressed"        : { value: "{color.violet.40.value}", attributes: { category: "color" } },
    ...
    // Positive
    "positive-color"                        : { value: "{color.green.80.value}", attributes: { category: "color" } },
    "positive-color-hover"                  : { value: "{color.green.90.value}", attributes: { category: "color" } },
    "positive-color-pressed"                : { value: "{color.green.100.value}", attributes: { category: "color" } },
    "positive-inverse-color"                : { value: "{color.green.20.value}", attributes: { category: "color" } },
    "positive-inverse-color-hover"          : { value: "{color.green.30.value}", attributes: { category: "color" } },
    "positive-inverse-color-pressed"        : { value: "{color.green.40.value}", attributes: { category: "color" } },
    ...
    // Negative
    "negative-color"                        : { value: "{color.red.80.value}", attributes: { category: "color" } },
    "negative-color-hover"                  : { value: "{color.red.90.value}", attributes: { category: "color" } },
    "negative-color-pressed"                : { value: "{color.red.100.value}", attributes: { category: "color" } },
    "negative-inverse-color"                : { value: "{color.red.20.value}", attributes: { category: "color" } },
    "negative-inverse-color-hover"          : { value: "{color.red.30.value}", attributes: { category: "color" } },
    "negative-inverse-color-pressed"        : { value: "{color.red.40.value}", attributes: { category: "color" } },
    ...
    // Warning
    "warning-color"                         : { value: "{color.yellow.80.value}", attributes: { category: "color" } },
    "warning-color-hover"                   : { value: "{color.yellow.90.value}", attributes: { category: "color" } },
    "warning-color-pressed"                 : { value: "{color.yellow.100.value}", attributes: { category: "color" } },
