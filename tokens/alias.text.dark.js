/**
* TEXT
* All text elements, including body, heading and code aliases
* ======================================================================== */

module.exports = {
  text: {
    "color-x-weak"      : { value: "{color.grey.0.value}", attributes: { category: "color" } },
    "color-weak"        : { value: "{color.grey.20.value}", attributes: { category: "color" } },
    "color"             : { value: "{color.grey.40.value}", attributes: { category: "color" } },
