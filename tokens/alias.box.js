/**
* BOX
* Separate an element from the surrounding UI
* ======================================================================== */
...
module.exports = {
  box: {
    ...
    "neutral-weak-color"                     : { value: "{color.grey.5.value}", attributes: { category: "color" } },
    "neutral-weak-color-hover"               : { value: "{color.grey.10.value}", attributes: { category: "color" } },
    "neutral-weak-color-pressed"             : { value: "{color.grey.20.value}", attributes: { category: "color" } },
    "neutral-weak-inverse-color"             : { value: "{color.grey.60.value}", attributes: { category: "color" } },
    "neutral-weak-inverse-color-hover"       : { value: "{color.grey.70.value}", attributes: { category: "color" } },
    "neutral-weak-inverse-color-pressed"     : { value: "{color.grey.80.value}", attributes: { category: "color" } },

    "neutral-strong-color"                   : { value: "{color.grey.40.value}", attributes: { category: "color" } },
    "neutral-strong-color-hover"             : { value: "{color.grey.50.value}", attributes: { category: "color" } },
    "neutral-strong-color-pressed"           : { value: "{color.grey.60.value}", attributes: { category: "color" } },
    "neutral-strong-inverse-color"           : { value: "{color.grey.0.value}", attributes: { category: "color" } },
    "neutral-strong-inverse-color-hover"     : { value: "{color.grey.5.value}", attributes: { category: "color" } },
    "neutral-strong-inverse-color-pressed"   : { value: "{color.grey.10.value}", attributes: { category: "color" } },

    "neutral-x-strong-color"                 : { value: "{color.grey.70.value}", attributes: { category: "color" } },
    "neutral-x-strong-color-hover"           : { value: "{color.grey.80.value}", attributes: { category: "color" } },
    "neutral-x-strong-color-pressed"         : { value: "{color.grey.90.value}", attributes: { category: "color" } },
    "neutral-x-strong-inverse-color"         : { value: "{color.grey.0.value}", attributes: { category: "color" } },
    "neutral-x-strong-inverse-color-hover"   : { value: "{color.grey.10.value}", attributes: { category: "color" } },
    "neutral-x-strong-inverse-color-pressed" : { value: "{color.grey.20.value}", attributes: { category: "color" } },
    ...
    "selected-inverse-color"                 : { value: "{color.violet.80.value}", attributes: { category: "color" } },
    "selected-inverse-color-hover"           : { value: "{color.violet.90.value}", attributes: { category: "color" } },
    "selected-inverse-color-pressed"         : { value: "{color.violet.100.value}", attributes: { category: "color" } },
