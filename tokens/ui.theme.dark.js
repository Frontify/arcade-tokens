module.exports = {
  ...
  highlight: {
    ...
    // Negative
    "negative-color"            : { value: "{color.negative-80.value}", attributes: { category: "color" } },
    "negative-color-inverse"    : { value: "{color.negative-10.value}", attributes: { category: "color" } },
    // Positive
    "positive-color"            : { value: "{color.positive-90.value}", attributes: { category: "color" } },
    "positive-color-inverse"    : { value: "{color.positive-10.value}", attributes: { category: "color" } },
    // Warning
    "warning-color"             : { value: "{color.warning-90.value}", attributes: { category: "color" } },
    "warning-color-inverse"     : { value: "{color.warning-10.value}", attributes: { category: "color" } },
    // Informative
    "interactive-color"         : { value: "{color.interactive-80.value}", attributes: { category: "color" } },
    "interactive-color-inverse" : { value: "{color.interactive-10.value}", attributes: { category: "color" } },
     // Strong
