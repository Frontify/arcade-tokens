module.exports = {
  ...
  heading: {
    ...
    size: {
      _: { value: "{heading.size.small._.value}", attributes: { category: "font", type: "size" } },
      small: {
        _: { value: "{body.size.small._.value}", attributes: { category: "font", type: "size" } },
      ...
      large: {
        _: { value: "{body.size.large._.value}", attributes: { category: "font", type: "size" } },
