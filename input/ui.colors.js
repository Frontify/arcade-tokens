...
module.exports = {
  color: {
    ...
    neutral: {
      _ : { value: "{color.neutral.2.value}" },
      hover: { value: "{color.neutral.3.value}"},
      pressed: { value: "{color.neutral.4.value}"},
    ...
    strong: {
      _ : { value: "{color.neutral.13.value}" },
      hover: { value: "color.neutral.14.value"},
      pressed: { value: "color.neutral.16.value"},
      inverse: {value: "color.darkest.value"},
    },
    interactive: {
      _ : { value: "{color.interactive.4.value}" },
      hover: { value: "{color.interactive.5.value}"},
      pressed: { value: "{color.interactive.6.value}"},
    ...
    positive: {
      ...
      hover: { value: "{color.positive.5.value}"},
      pressed: { value: "{color.positive.6.value}"},
      inverse: {value: "{color.lightest.value}"},
    ...
    warning: {
      _ : { value: "{color.warning.4.value}" },
      hover: { value: "{color.warning.5.value}"},
      pressed: { value: "{color.warning.6.value}"},
      inverse: {value: "{color.lightest.value}"},
    ...
    negative: {
      _ : { value: "{color.negative.4.value}" },
